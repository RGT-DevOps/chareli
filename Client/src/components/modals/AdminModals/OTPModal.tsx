    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white">
      ...
      <div className="bg-white rounded-2xl p-10 w-[500px] max-w-full shadow-none border border-none flex flex-col items-center relative">
        <form className="w-full flex flex-col gap-6 justify-start" onSubmit={handleSubmit}>
          <div>
            <label className="block text-4xl mb-2 font-pong tracking-wider">
              Verify Account
            </label>
                  ...
                  return (
                    <div className="px-2 py-0 border-1 border-[#E328AF] mx-4 rounded">
                      <input
                        {...props}
                        readOnly={isFilled}
                        className="w-12 h-12 text-center bg-transparent rounded-none dark:text-white text-black font-pong text-2xl font-bold mx-1 focus:outline-none focus:ring-0"
                      />
                    </div>
                  );
                }}
