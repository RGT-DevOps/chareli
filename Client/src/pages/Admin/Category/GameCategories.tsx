    ...
    <div className="p-8">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
        ...
        {permissions.canManageGames && (
          <button
            className="bg-[#DC8B18] text-white px-3 py-2 sm:py-3 rounded-lg text-sm sm:text-base tracking-wide hover:bg-[#DC8B18] transition self-start sm:self-auto font-dmmono cursor-pointer"
